...
import { X, Database, Copy, Check, RefreshCw, Info, Lock } from "lucide-react";
          ...
          <div className="p-4 rounded-xl border flex items-start gap-3 bg-emerald-50 border-emerald-200 text-emerald-800">
            ...
            <div>
              ...
              <p className="text-xs mt-1 leading-relaxed">
                Aplikasi Anda tersinkronisasi langsung dengan server Supabase
                Anda secara aman. RLS diaktifkan sehingga data hanya bisa
                diakses oleh akun Anda sendiri.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  Jalankan script ini di SQL Editor Supabase Anda agar tabel dan
                  kebijakan (RLS) terbuat otomatis.
                </p>
              </div>
              <button
                onClick={handleCopy}
